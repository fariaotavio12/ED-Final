...
public class Janela extends JFrame{
	...
	private void encheLista() {
		Arma arma1 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma2 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma3 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma4 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma5 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma6 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
		
		Arma arma7 = new Arma ("Harry Potter A", "JK Rowling","aaa,","aaa", "Rocco", "aa");
